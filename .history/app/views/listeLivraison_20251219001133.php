            ...
            <tbody>
                <tr>
                    <?php foreach($listeLivraisons as $listeLivraison) { ?>
                        <td><?php echo $listeLivraison['chiffreAffaire'] ?></td>
                        <td><?php echo $listeLivraison['coutRevient'] ?></td>
                        <td><?php echo $listeLivraison['benefice'] ?></td>
                        <td><?php echo $listeLivraison['date'] ?></td>
                    <?php } ?>
                </tr>
            </tbody>
