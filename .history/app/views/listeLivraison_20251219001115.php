...
<body>
    ...
    <div class="col-md-10 container mt-5 shadow p-5 rounded">
        <table class="table table-hover text-center col-md-7 border rounded">
            ...
            <tbody>
                <tr>
                    <?php foreach($listeLivraisons as $listeLivraisons) { ?>
                        <td><?php echo $listeLivraisons['chiffreAffaire'] ?></td>
                        <td><?php echo $listeLivraisons['coutRevient'] ?></td>
                        <td><?php echo $listeLivraisons['benefice'] ?></td>
                        <td><?php echo $listeLivraisons['date'] ?></td>
                    <?php } ?>
                </tr>
            </tbody>
