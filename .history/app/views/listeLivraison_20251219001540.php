...
<body>
    ...
    <h3 class="text-center text-primary mt-5">Les livraison en attente</h3>
        ...
        <table class="table table-hover text-center col-md-7 border rounded">
            <thead>
                <tr>
                    ...
                    <td  style="background-color: #000b73; color: #ffffff">adresseDepart</td>
                    <td  style="background-color: #000b73; color: #ffffff">adresseDestination</td>
            ...
            <tbody>
                <tr>
                    <?php foreach($listeLivraisons as $listeLivraison) { ?>
                        ...
                        <td><a href="/livraison/listeLivraison/<?php echo $listeLivraison['daty'] ?>" class="btn btn-outline-primary">Livrer</a></td>
                    <?php } ?>
                </tr>
            </tbody>
