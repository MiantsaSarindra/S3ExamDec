...
// $app->set('flight.base_url', 'ETU003947/',);           // Base URL for your app. Change if app is in a subdirectory (e.g., '/myapp/')
...
return [
	...
	// 	// MySQL Example:
	// 	'host'     => 'localhost',      // Database host (e.g., 'localhost', 'db.example.com')
	// 	'dbname'   => 'db_s2_ETU003947',   // Database name (e.g., 'flightphp')
	// 	'user'     => 'ETU003947',  // Database user (e.g., 'root')
	// 	'password' => '1R9Qn1rm',  // Database password (never commit real passwords)
